...
package controle_de_acesso_menu_e_submenu;

import br.com.jmary.home.Home;
import controle_de_acesso.Controle_De_Acesso_01_Indice;

/**
 *
 * @author ana
 */
public class Controle_De_Acesso_Submenu_01 extends javax.swing.JPanel {

    Home Home;
        
    public Controle_De_Acesso_Submenu_01( Home Home2 ) {
        Home = Home2;
    ...
    private void btExercicios5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExercicios5MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            Home.ControleTabs.AddTabsAoHome("Usuários do Sistema Índice", "livroTp.gif", new Controle_De_Acesso_01_Indice(Home) ); 
