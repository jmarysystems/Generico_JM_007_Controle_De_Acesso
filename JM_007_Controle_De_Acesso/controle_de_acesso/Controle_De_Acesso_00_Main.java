...
import controle_de_acesso_menu_e_submenu.Controle_De_Acesso_Menu_01;
 ...
 * @author NewUser
 */
public class Controle_De_Acesso_00_Main extends JApplet {
    ...
    public void init() {
        ...
        Home.adicionar_Menu(new Controle_De_Acesso_Menu_01( Home ).Barra_Menu );
    ...
    public static void main(String[] args) {
        ...
        JApplet applet = new Controle_De_Acesso_00_Main();
        applet.init();
