...
import controle_de_acesso_03_cadastro_automatizado_ajuda.Controle_De_Acesso_03_Cadastro_Automatizado_Ajuda;
import controle_de_acesso_beans.ControleDeAcesso;
import controle_de_acesso_excel.Controle_De_Acesso_Excel_Modelo;
import controle_de_acesso_imprimir.Controle_De_Acesso_Imprimir_01_Controle;
 ...
 * @author AnaMariana
 */
public class Controle_De_Acesso_04_Consultar extends javax.swing.JPanel {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////     
     ...
     * @param Home2 */
    public Controle_De_Acesso_04_Consultar( Home Home2 ) {
        initComponents();
    ...
    public DefaultTableModel                tmPesquisa = new DefaultTableModel( null, new String[]{ 
                "ID", "NOME_DA_TABELA", "ID_USER", "ACESSO_A_TABELA", 
                "VISUALIZAR", "CONSULTAR", "ALTERAR", 
                "EXCLUIR", "CONSULTA_SQL", "CADASTRAR", "CADASTRO_AUTO", 
                "DATA_CADASTRO", "ID USER CADASTROU",
                "ID USER ALTEROU", "DATA_ALTERACAO"
            } );
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////             
            ...
            sc.setViewportView(new Visualizador_Interno(Home,img_Atual,quantidade_de_arquivos_ajuda,Controle_De_Acesso_03_Cadastro_Automatizado_Ajuda.class) );
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////             
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Controle de Acesso - Consulta");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////            
        ...
        if ( numLinhas != -1){
            try {         
                ...
                Class<Controle_De_Acesso_Excel_Modelo> clazz_Entrada_Excel = Controle_De_Acesso_Excel_Modelo.class;
                ////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////            
            ...
            Controle_De_Acesso_Imprimir_01_Controle t1 = new Controle_De_Acesso_Imprimir_01_Controle( tbPesquisa );
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////         
        ...
        if( contentsX.equals("") ){
            ...
            if( tipoConsulta.equals("TUDO") ){
                ...
                try{ 
                    Query q = JPAUtil.em().createNativeQuery("SELECT * FROM JM.CONTROLE_DE_ACESSO", ControleDeAcesso.class );
                    List<ControleDeAcesso> lista_Banco = q.getResultList();   
                    ControleDeAcesso = lista_Banco;
                }catch( Exception e ){ }
                
                String rbusca = ""; try{ rbusca = ControleDeAcesso.get(0).getNomeDaTabela(); }catch( Exception e ){}
                if( !rbusca.equals("") ){
                    
                    Exportando.pbg.setMaximum( ControleDeAcesso.size() );
                    
                    for (int it = 0; it < ControleDeAcesso.size(); it++){
                        Exportando.pbg.setValue( it );
                        
                        setar_na_tabela( ControleDeAcesso.get(it) );
                    }
                }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
                            ...
                            if( tipoConsulta.equals("CÓDIGO AUXILIAR") ){
                                ...
                                try{ 
                                    ...
                                    DAOGenericoJPA DAOGenericoJPAXX = new DAOGenericoJPA(ControleDeAcesso.class, JPAUtil.em());
                                    ControleDeAcesso = (List<ControleDeAcesso>) DAOGenericoJPAXX.getBeansCom_1_Parametro(ControleDeAcesso.class, 
                                            "SELECT * FROM JM.CONTROLE_DE_ACESSO WHERE NOME_DA_TABELA = ?", material_procurado );
                                }catch( Exception e ){ }
                                    
                                String rbusca = ""; try{ rbusca = ControleDeAcesso.get(0).getNomeDaTabela(); }catch( Exception e ){}
                                if( !rbusca.equals("") ){
                                        
                                    setar_na_tabela( ControleDeAcesso.get(0) );
                                } 
                                else{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////                                    
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////                                    
                                ...
                                try{ 
                                    DAOGenericoJPA DAOGenericoJPAXX = new DAOGenericoJPA(ControleDeAcesso.class, JPAUtil.em());
                                    ControleDeAcesso = (List<ControleDeAcesso>) DAOGenericoJPAXX.getBeansCom_1_Parametro(ControleDeAcesso.class, 
                                            "SELECT * FROM JM.CONTROLE_DE_ACESSO WHERE ID = ?", material_procurado );
                                }catch( Exception e ){ }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////                                    
                                ...
                                try{ 
                                    DAOGenericoJPA DAOGenericoJPAXX = new DAOGenericoJPA(ControleDeAcesso.class, JPAUtil.em());
                                    ControleDeAcesso = (List<ControleDeAcesso>) DAOGenericoJPAXX.getBeansCom_1_Parametro(ControleDeAcesso.class, 
                                            "SELECT * FROM JM.CONTROLE_DE_ACESSO WHERE NOME_DA_TABELA LIKE ?", material_procurado.toUpperCase() );
                                }catch( Exception e ){ }
...
private void setar_na_tabela(ControleDeAcesso ControleDeAcesso){
        try{      
            
            int    ID = 0;
            String NOME_DA_TABELA = "";
            int    ID_USER = 0;
            boolean ACESSO_A_TABELA = false;
            boolean VISUALIZAR = false;           
            boolean CONSULTAR = false;
            boolean ALTERAR = false;
            boolean EXCLUIR = false;
            boolean CONSULTA_SQL = false;
            boolean CADASTRAR = false;
            boolean CADASTRO_AUTO = false;
            
            String DATA_CADASTRO = "";
            int    ID_USUARIO_SISTEMA_CADASTRO_CONTROLE_DE_ACESSO = 0;
            int    ID_USUARIO_SISTEMA_ALTERACAO_CONTROLE_DE_ACESSO = 0;  
            String DATA_ALTERACAO = "";
//////////////////////////////////////////////////////////////////////////////////////////////////////////                            
            String rbusca = ""; try{ rbusca = ControleDeAcesso.getNomeDaTabela(); }catch( Exception e ){}
            if( !rbusca.equals("") ){
                ...
                try{ ID = ControleDeAcesso.getId(); }catch( Exception e ){}   
                try{ NOME_DA_TABELA = ControleDeAcesso.getNomeDaTabela(); }catch( Exception e ){}
                try{ ID_USER = ControleDeAcesso.getIdUsuarioSistemaQueVaiAcessar(); }catch( Exception e ){}
                try{ ACESSO_A_TABELA = ControleDeAcesso.getAcessoATabela(); }catch( Exception e ){}                
                try{ VISUALIZAR = ControleDeAcesso.getVisualizar(); }catch( Exception e ){}                    
                try{ CONSULTAR = ControleDeAcesso.getConsultar(); }catch( Exception e ){}
                try{ ALTERAR = ControleDeAcesso.getAlterar(); }catch( Exception e ){}
                try{ EXCLUIR = ControleDeAcesso.getExcluir(); }catch( Exception e ){}
                try{ CONSULTA_SQL = ControleDeAcesso.getConsultaSql(); }catch( Exception e ){}
                try{ CADASTRAR = ControleDeAcesso.getCadastrar(); }catch( Exception e ){}
                try{ CADASTRO_AUTO = ControleDeAcesso.getCadastroAuto(); }catch( Exception e ){}   
                try{ DATA_CADASTRO = dfmt.format( ControleDeAcesso.getCadastrar()); }catch( Exception e ){}
                try{ ID_USUARIO_SISTEMA_CADASTRO_CONTROLE_DE_ACESSO  = ControleDeAcesso.getIdUsuarioSistemaCadastroControleDeAcesso(); }catch( Exception e ){}
                try{ ID_USUARIO_SISTEMA_ALTERACAO_CONTROLE_DE_ACESSO = ControleDeAcesso.getIdUsuarioSistemaCadastroControleDeAcesso(); }catch( Exception e ){}
                try{ DATA_ALTERACAO = dfmt.format( ControleDeAcesso.getDataAlteracao()); }catch( Exception e ){}
            }                               
///////////////////////////////////////////////////////////////////////////////////////////////////////////             
            
            tmPesquisa.addRow(new Object[]{ ID, NOME_DA_TABELA, 
                ID_USER, ACESSO_A_TABELA, 
                VISUALIZAR, CONSULTAR, 
                ALTERAR, EXCLUIR,
                CONSULTA_SQL, CADASTRAR,
                CADASTRO_AUTO, 
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            if ( tbPesquisa.getSelectedRow() != -1){
                ...
                if( lbVisualizar.isEnabled() == true ){
                    ...
                    List<ControleDeAcesso>  List_ControleDeAcesso = null;
                    int id = 0;
                    ...
                    List<ControleDeAcesso> List_2_ControleDeAcesso = null;
                    try{
                        Query q2 = JPAUtil.em().createNativeQuery("SELECT * FROM JM.CONTROLE_DE_ACESSO WHERE ID = ?", ControleDeAcesso.class );
                        q2.setParameter( 1, id ); 
                        List_2_ControleDeAcesso = q2.getResultList();
                    }catch(Exception e){}
                    
                    String rbusca = ""; try{ rbusca = List_2_ControleDeAcesso.get(0).getNomeDaTabela(); }catch( Exception e ){}
                    if( !rbusca.equals("") ){
                        
                        UsuarioSistema UsuarioSistema_Get = get_UsuarioSistema( Login.Usuario_Logado.getId() ); 
                                            
                        Home.ControleTabs.AddTabComControle(jTabbedPane1, "Alterar Usuário", "livroTp.gif", 
                        new Controle_De_Acesso_02_Cadastrar_Visualizar( Home, jTabbedPane1, "Alterando...", List_2_ControleDeAcesso.get(0), UsuarioSistema_Get ) );
                    }
                ...
                Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                JOPM JOptionPaneMod = new JOPM( 1, "ALTERAR CONTROLE_DE_ACESSO SELECIONADO\n"
                        + "\nPARA ALTERAR CONTROLE_DE_ACESSO SELECIONADO\n"
                        + "\nPRIMEIRO SELECIONE UMA CÉLULA\n"
                        + "\nOK Para Prosseguir"
                        ,"Class: " + this.getClass().getName(),
                        new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
            ...
            if ( tbPesquisa.getSelectedRow() != -1){
                ...
                if( lbDesativar.isEnabled() == true ){
                    ...
                    if( !rbusca.equals("") ){
                        ...
                        //Home.ControleTabs.AddTabComControle(jTabbedPane1, "Alterar Usuário", "livroTp.gif", 
                        //new Controle_De_Acesso_02_Cadastrar_Visualizar( Home, "Alterando...", List_2_UsuarioSistema.get(0) ) );
            ...
            if ( tbPesquisa.getSelectedRow() != -1){
                ...
                if( lbVisualizar.isEnabled() == true ){
                    ...
                    if( !rbusca.equals("") ){
                        ...
                        new Controle_De_Acesso_02_Cadastrar_Visualizar( Home, jTabbedPane1, "Visualizando...", List_2_UsuarioSistema.get(0) ) );
                    }
