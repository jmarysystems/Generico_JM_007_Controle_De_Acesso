 ...
 * @author Ana
 */
public class Controle_De_Acesso_Imprimir_03_Imprimindo extends Thread { 
    ...
    public Controle_De_Acesso_Imprimir_03_Imprimindo( List<File> lista_Arquivos2  ){   
    ...
    public void impressora(){  
        synchronized(this) { 
            ...
            Controle_De_Acesso_Imprimir_04_Impressora Impressora = new Controle_De_Acesso_Imprimir_04_Impressora( "" );
    ...
    public void imprimirComPropriedadesEConfigurações() { 
        ...
        */
        ...
        synchronized(this) {
            ...
            synchronized(this) {
                Printable pTable  = new Controle_De_Acesso_Imprimir_05_PrintX_JM( htmlPanePrincipal, PrinterJob, aset );    
