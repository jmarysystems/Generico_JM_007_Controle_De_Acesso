 ...
 * @author i
 */
public class Controle_De_Acesso_Imprimir_05_PrintX_JM implements Printable {
    PrinterJob pJob2;
    ...
    public Controle_De_Acesso_Imprimir_05_PrintX_JM( JEditorPane pane, PrinterJob pJob, PrintRequestAttributeSet aset ) { try { 
